...
namespace eqdseq
{
    ...
    public class JobGiver_IdleLovin : ThinkNode_JobGiver
    {
        ...
        protected override Job TryGiveJob(Pawn pawn)
        {
            ...
            if (tempData.lastTryTick > Find.TickManager.TicksGame)
            {
                return null;
            }
            ...
            if (!ownedBed.Spawned)
            {
                tempData.lastTryTick = ticksGame + 15000;
                return null;
            }
            ...
            foreach (IntVec3 item in ownedBed.OccupiedRect())
            {
                ...
                {
                    tempData.lastTryTick = ticksGame + 5000;
                    return null;
                }
            }
            ...
            //{
            //    tempData.lastTryTick = ticksGame + 10000;
            //    return null;
            //}
            ...
            if (tempData.laborCheckTick < ticksGame)
            {
                ...
                if (pawn.health.hediffSet.InLabor(true))
                {
                    ...
                    tempData.lastTryTick = ticksGame + 60000;
                    return null;
                }
                int num = 360000;
            ...
            foreach (Pawn pawn2 in ownedBed.OwnersForReading)
            {
                ...
                {
                    tempData2.lastCheckTick = ticksGame + 5000;
                    lastCheckTickTemp = tempData2.lastCheckTick;
                    continue;
                }
                ...
                //{
                //    tempData2.lastCheckTick = ticksGame + 10000;
                //    lastCheckTickTemp = tempData2.lastCheckTick;
                //    continue;
                //}
                ...
                if (tempData2.laborCheckTick < ticksGame)
                {
                    ...
                    if (pawn2.health.hediffSet.InLabor(true))
                    {
                        ...
                        tempData2.lastTryTick = ticksGame + 60000;
                        lastCheckTickTemp = tempData2.lastCheckTick;
                        continue;
                    }
                    int nums = 360000;
                ...
                if (pawn2curJobdef == JobDefOf.Wait_Asleep && pawn2JobTag == JobTag.SatisfyingNeeds && pawn2.Position == sleepingSpot2 && pawn2.jobs.posture == PawnPosture.LayingInBed)
                {
                    ...
                    if (!pawnCanReachCheck)
                    {
                        ...
                        {
                            tempData.lastCheckTick = ticksGame + 5000;
                ...
                if (pawn2JobTag == JobTag.Idle)
                {
                    if (pawn2curJobdef == JobDefOf.GotoWander || pawn2curJobdef == JobDefOf.Wait_Wander)
                    {
                        ...
                        {
                            tempData2.lastCheckTick = ticksGame + 2500;
                            tempData2.lastTryTick = ticksGame + 5000;
                            lastCheckTickTemp = tempData2.lastCheckTick;
                            continue;
                        }
                ...
                if ((pawn2JobTag == JobTag.SatisfyingNeeds || pawn2Idle) && pawn2curJobdef.joyKind != null)
                {
                    ...
                    {
                        tempData2.lastCheckTick = ticksGame + 250;
                        lastCheckTickTemp = tempData2.lastCheckTick;
                        continue;
                    }
            ...
            {
                tempData.lastTryTick = lastCheckTickTemp + (tempData.lastTryCount * Rand.Range(200, 750));
                return null;
            }
            tempData.lastTryTick += (tempData.lastTryCount * Rand.Range(200, 750)) + sharedBedNonSpouse;
            return null;
        }
    }
        ...
        private static readonly SimpleCurve LovinIntervalHoursFromAgeCurve = new SimpleCurve
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            {
                ticksReady--;
                if (Partner != null && Partner.jobs.posture == PawnPosture.LayingInBed)
                {
            ...
            toil2.AddFinishAction(delegate
            {
                ...
                {
                    tempData.lastTryTick = Find.TickManager.TicksGame + Rand.Range(500, 5000);
                    return;
                }
